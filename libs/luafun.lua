...
--------------------------------------------------------------------------------
--- Wildstar-specific things.
--------------------------------------------------------------------------------

require "Apollo"

local MAJOR, MINOR = "lib:fun", 1
local aPkg = Apollo.GetPackage(MAJOR)
if aPkg and (aPkg.nVersion or 0) >= MINOR then return end
local libFun = aPkg and aPkg.tPackage or {}


--------------------------------------------------------------------------------
--- Original fun.lua code begins here
--------------------------------------------------------------------------------
...
local operator = {
    ...
    lnot = function(a) return not ba end,
...
---
--- Original luafun code commented out because it isn't useful in WS lua
---
...
--------------------------------------------------------------------------------
--- More Wildstar-specific stuff
--------------------------------------------------------------------------------

local function import(a)
  local imp = {}
  exports.each(function(v) imp[v] = exports[v] end, a)
  return imp
end

exports.import = import

libFun = libFun and exports
Apollo.RegisterPackage(libFun, MAJOR, MINOR, {})
